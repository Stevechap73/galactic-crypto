...
import { CardContainerTestAccueil } from "./cardContainerTestAccueil";
import { CryptoAllProps } from "@/Utils/type";
import { CardTestAccueil } from "./cardTestAccueil";

export const MainAccueil = () => {
        ...
        <div className=" relative z-20 max-w-screen-lg mx-auto grid grid-cols-12 h-full items-center">
          <div className="col-span-6">
            ...
            <h1 className="text-white font-extrabold text-5xl mb-8">
              Galactic-Crypto fournit des services de conseil en cryptomonnaie
              de différentes manières.
            </h1>
            <p className="text-stone-100 text-base">
              Découvrez Galactic-Crypto, votre passerelle vers l'avenir
              financier. Investissez dans les cryptomonnaies les plus
              prometteuses et sécurisées dès aujourd'hui. Rejoignez notre
              communauté et faites fructifier vos actifs avec Galactic-Crypto !
            </p>
            <button
